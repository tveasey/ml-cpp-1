...
BOOST_AUTO_TEST_CASE(testPiecewiseLinearScaledSeasonal) {
    ...
    std::size_t minimumSegmentLength[]{48, 48, 48};
    ...
    // Same again but with 1% salt-and-pepper outliers.
