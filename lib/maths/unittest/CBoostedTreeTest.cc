...
std::size_t predictionColumn(const core::CDataFrame& frame,
                             const maths::CBoostedTree& regression) {
    return regression.columnHoldingPrediction(frame.numberColumns());
}
