...
const core_t::TTime
    CAnomalyDetectorModelConfig::DEFAULT_MINIMUM_TIME_TO_DETECT_CHANGE(36 * core::constants::HOUR);
const core_t::TTime
    CAnomalyDetectorModelConfig::DEFAULT_MAXIMUM_TIME_TO_TEST_FOR_CHANGE(48 * core::constants::HOUR);
